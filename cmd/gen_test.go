...
func TestGenCommand_SimpleFile(t *testing.T) {
	...
	assertContains(t, out, "# Managed by hitch")
	assertContains(t, out, "Description=hitch: myapp")
...
func TestGenCommand_WithNetworks(t *testing.T) {
	...
	assertContains(t, out, "Description=hitch: mystack")
...
func TestGenCommand_WithNameFlag(t *testing.T) {
	...
	assertContains(t, out, "Description=hitch: custom-name")
}
